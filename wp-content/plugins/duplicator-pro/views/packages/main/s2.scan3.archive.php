...
<!-- ======================
ADDON SITES -->
<div id="addonsites-block"  class="scan-item" style="display:none;">
	<div class='title' onclick="DupPro.Pack.toggleScanItem(this);">
	...
	<div class="info">
		<small>
		<?php
			printf(DUP_PRO_U::__("We have detected what <i>may be</i> separate WordPress sites residing in subdirectories within this site. If you confirm these to be "
				. "separate sites, don't back these up using this site. Instead, add these directories to the directory filters on this site then back those sites up separately."));
		?>
		</small>
