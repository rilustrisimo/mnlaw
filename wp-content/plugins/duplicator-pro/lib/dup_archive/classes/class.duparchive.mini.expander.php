...
class DupArchiveMiniFileHeader
{
    ...
    static function readFromArchive($archiveHandle)
    {
        ...
        $instance->md5                = DupArchiveHeaderMiniU::readStandardHeaderField($archiveHandle, 'MD5');
...
//    const MaxHeaderSize = 50;
    ...
    public static function readFromArchive($archiveHandle)
    {
        ...
        $instance->version           = (int)DupArchiveHeaderMiniU::readStandardHeaderField($archiveHandle, 'V');
